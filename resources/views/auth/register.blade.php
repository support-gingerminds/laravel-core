                                            ...
                                            <form method="POST" class="form-horizontal" action="{{ route('register') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group" id="datepicker1">
                                                        <input type="text" class="form-control @error('dob') is-invalid @enderror" id="userdob" placeholder="dd-mm-yyyy"
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <ul class="list-inline">
                                                        <li class="list-inline-item">
                                                            <button type="button"
                                                                class="social-list-item bg-primary text-white border-primary border-0">
                                                                <i class="mdi mdi-facebook"></i>
                                                            </button>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <button type="button"
                                                                class="social-list-item bg-info text-white border-info border-0">
                                                                <i class="mdi mdi-twitter"></i>
                                                            </button>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <button type="button"
                                                                class="social-list-item bg-danger text-white border-danger border-0">
