...
@php
    $action = route('gingerminds-core.contributors.store');
    $indexRoute = route('gingerminds-core.contributors.index');
    $method = 'POST';
    $id = 'editcontributeur-form';
    $title = __('gingerminds-core::translation.title_m_create', ['model' => __('gingerminds-core::translation.contributors.name_s')]);
    $subtitle = null;
@endphp
